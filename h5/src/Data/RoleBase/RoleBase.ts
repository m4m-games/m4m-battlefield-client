...
export class RoleBase extends ExcelDataBase{
	...
	*/
	...
	/**行走退出延迟(毫秒)*/
	public walkOutDelay :number;
	/**站立退出延迟(毫秒)*/
	public standOutDelay :number;
	/**站立退出延迟(毫秒)*/
	public runOutDelay :number;
...
return clone;
	...
	private static params = ["id","name","desc","bodyScale","walkOutDelay ","standOutDelay ","runOutDelay ",];
