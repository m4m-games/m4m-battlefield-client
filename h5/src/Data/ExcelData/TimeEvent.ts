...
public   clone(old:TimeEvent){
	...
	private static params = ["id","eventName","taskstartTime","taskEndTime","lastStartTime","lastEndTime","serverTimeZone","LoopCount","LoopTimers","isFristNoCD","taskLoopTime","startTime","startLimitTime","predecessorTaskID","taskEventString","taskEventLog","taskState","taskPreviousState",];
