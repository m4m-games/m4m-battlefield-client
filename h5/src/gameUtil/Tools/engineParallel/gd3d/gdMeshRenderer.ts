...
export class gdMeshRenderer implements ISpMeshRenderer {
    ...
    public id: string;
    public rawHandle: gd3d.framework.meshRenderer;
    public compType: spComponentType = spComponentType.meshRenderer;
    public gameObject: gd3dGO;

    constructor(rawCam: gd3d.framework.meshRenderer, go: gd3dGO) {
    ...
    public setMaterialVector4(key: string, value: gd3d.math.vector4, idx: number = 0) {
        if (!this.rawHandle.materials[idx]) { return; }
