...
export class IconUtil {
    ...
    /*原UIshader
     **/
    public static defuiShaderName: string = "shader/defui";
    /*原UIshader(mask)
     **/
    public static defMaSkUIShaderName: string = "shader/defmaskui";
    /*图片灰白shader
    **/
    ...
    原字体shader
    **/
    public static defuiFontShaderName: string = "shader/defuifont";
