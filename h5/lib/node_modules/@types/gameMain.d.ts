...
declare module "Core/blockchain/ConnectWalletManager" {
    export class ConnectWalletManager {
        ...
        constructor();
        init(): void;
        loginToken(callBackFun: Function): void;
        private static _instance;
        private wallet;
        private M4M_SDK;
...
declare module "Core/blockchain/BlockSubscriptionIndex" {
    export class BlockSubscriptionIndex {
        tonweb: any;
        lastProcessedMasterchainBlockNumber: any;
        onTransaction: Function;
        indexApiUrl: any;
        indexApiKey: any;
        constructor(tonweb: any, lastProcessedMasterchainBlockNumber: any, onTransaction: Function, indexApiUrl: any, indexApiKey: any);
        start(): Promise<void>;
    }
}
declare module "Core/blockchain/DepositsJettons" {
    export const TONCENTER_API_KEY: string;
    export const NODE_API_URL: string;
    export const INDEX_API_URL: string;
    export const MY_HOT_WALLET_ADDRESS = "EQB7AhB4fP7SWtnfnIMcVUkwIgVLKqijlcpjNEPUVontypON";
    export class DepositsJettons {
        TonWeb: any;
        tonwebsdk: any;
        static get Instance(): DepositsJettons;
        private static _instance;
        jettons: {};
        TopUpAmount: any;
        constructor();
        ...
        jettonsInfo: {
            jUSDC: {
                address: string;
                decimals: number;
                hasStandardInternalTransfer: boolean;
        ...
        userIdToTonWallet: {};
        userIdToJettonWallet: {};
        createDepositWallet(userId: any, keyPair: any): Promise<any>;
        createWallet(keyPair: any): any;
        depositsRequests: any[];
        onTransaction(tx: any): Promise<boolean>;
        findDepositAddress(addressString: any): {
            userId: string;
            jettonName: string;
        };
        validateJettonTransfer(txFromIndex: any, jettonName: any): Promise<boolean>;
        processDeposit(request: any): Promise<boolean>;
        isProcessing: boolean;
        processDepositsTick(): Promise<void>;
    }
}
declare module "Core/blockchain/BlockSubscriptionRaw" {
    export class BlockSubscriptionRaw {
        tonweb: any;
        startMasterchainBlockNumber: any;
        onTransaction: any;
        constructor(tonweb: any, startMasterchainBlockNumber: any, onTransaction: any);
        start(): Promise<void>;
    }
}
declare module "Core/blockchain/Deposits" {
    export const IS_TESTNET = true;
    export const TONCENTER_API_KEY = "0b6ec5b0242bd7bdd6c24a2dc2cf1c8246713a5adefddbd09fb4c69608ecd901";
    export const NODE_API_URL: string;
    export const INDEX_API_URL: string;
    export const MY_HOT_WALLET_ADDRESS = "EQB7AhB4fP7SWtnfnIMcVUkwIgVLKqijlcpjNEPUVontypON";
    export class Deposits {
        static get Instance(): Deposits;
        private static _instance;
        TonWeb: any;
        tonwebsdk: any;
        constructor();
         ...
         * @return {boolean}
         */
        isDepositAddress(address: any): Promise<boolean>;
        createWallet(keyPair: any): any;
        /**
         * @param tx    {Object}
         * @return {Promise<void>}
         */
        processDeposit: (tx: any) => Promise<void>;
        onTransaction: (tx: any) => Promise<void>;
        init(): Promise<void>;
    }
}
declare module "Core/blockchain/Jetton" {
    export const TonWeb: any;
    export const tonweb: any;
    export const getJettonBalance: (jettonAddr: string, owner: string) => Promise<number>;
}
declare module "Core/blockchain/Withdrawals" {
